     ...
     Formé au design d’objet et passionné par le bois, j’allie créativité et savoir-faire artisanal pour concevoir des trophées uniques. Mon approche associe l’élégance du design contemporain à la précision de l’ébénisterie traditionnelle, afin de créer des pièces sur mesure qui allient esthétisme et durabilité.
      ...
      <div>
        ...
        <div className="text-black mx-4 sm:mx-8 md:mx-12">
            ...
            <div className='bg-[#5A6A4F] sm:flex-row bg-opacity-10 p-6 rounded-lg max-w-2xl sm:w-1/3 text-white h-48 md:h-64 lg:h-80 flex flex-col justify-center items-center'> 
              <h3 className='text-3xl font-bolder text-center uppercase md:m-8'>Gravure Laser</h3>
              <p className="mx-4 sm:mx-8 text-justify">Textes, logos, motifs détaillés directement incrustés dans le bois</p>
            </div>
            </div>  
            ...
            <div className='bg-[#5A6A4F] bg-opacity-10 p-6 rounded-lg max-w-2xl sm:w-1/3 text-white h-48 md:h-64 lg:h-80 flex flex-col justify-center'>
              ...
              <p className="mx-auto px-4 sm:px-0 text-justify"> Des couleurs éclatantes et des détails précis. Logos, textes, visuels ou photos peuvent être
reproduits directement sur le bois, pour un rendu moderne et durable.</p>
        ...
        <div
          className="flex flex-col md:flex-row justify-center items-center gap-4 min-h-[66vh] bg-cover bg-center bg-fixed w-full max-w-7xl mx-auto"
